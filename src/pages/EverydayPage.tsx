...
const fallbackDialogue = dialogueExercises.find((d) => d.track === 'everyday')!
...
export function EverydayPage() {
  ...
  async function handleGenerate() {
    ...
    setError(null)
    try {
      const generated = await generateDialogue('everyday')
    ...
    <div className="flex flex-col gap-6">
      <div className="flex flex-wrap items-center justify-between gap-4">
        ...
        <button
          ...
          className="flex items-center gap-2 rounded-xl bg-accent-everyday px-5 py-2.5 font-bold text-white transition-transform active:scale-95 disabled:opacity-60"
        >
